class CommentsController < ApplicationController
  ...
  def create
    ...
    if comment.save
      ...
      render json: {
        error: I18n.t('backend.errors.comment.create', message: comment.errors.full_messages)
  ...
  def update
    ...
    if comment.save
      ...
      render json: {
        error: I18n.t('backend.errors.comment.update', message: comment.errors.full_messages)
      }, status: :unprocessable_entity
    end
  end
